...
.mixture-container {
  ...
  padding-left: 16px;
  padding-right: 16px;
  max-width: 600px; /* Optional: Limits stretching too far */
...
/* Section 2: Monthly/Yearly toggle */
.section-2 {
  display: flex;
  align-items: center;
